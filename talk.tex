...
\begin{frame}{Is It Any Good?}
    ...
    \includegraphics<3>{gen-graph-others-zoom-spoiler.pdf}
...
\begin{frame}{Search Order}
    \begin{itemize}
        ...
        \item Value ordering: highest degree to lowest.
            \begin{itemize}
                \item The main focus of this talk.
            \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{More on Value-Ordering Heuristics}
    \begin{itemize}
...
\begin{frame}{Discrepancy Search}
    ...
    \only<1>{
        \begin{itemize}
            \item Going against a value-ordering heuristic is called a \emph{discrepancy}.
            \item Conjecture 1: the total number of discrepancies to find a solution is usually quite low.
            \item Conjecture 2: early value choices are most likely to be incorrect.
            \item Definite fact: early mistakes are exponentially more expensive than later
                mistakes.
            \item Discrepancy searches offset this, at the cost of introducing overheads.
        \end{itemize}
    }%
    \includegraphics<2>{gen-graph-scatter-dds.pdf}
...
\begin{frame}{Ongoing Work}
    ...
    \begin{itemize}
        \item This works well for maximum common subgraph too.
        \item What about CP in general?
        \item Parallel!
    \end{itemize}
